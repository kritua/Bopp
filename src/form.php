...
if (empty($_POST['phone'] || $_POST['phone-1'] || $_POST['phone-2'] || $_POST['phone-3'])) exit(json_encode(array('res' => 'danger', 'msg' => 'Укажите номер телефона')));
...
$mail = new PHPMailer;
$mail->CharSet = 'UTF-8';
$mail->setFrom('zayavka@vestapack.ru', 'Vestapack');
$mail->addAddress('kritua2@gmail.com');
$mail->addAddress('Zayavka@vestapack.ru');
$mail->addAddress('pleergavno@yandex.ru');
$mail->Subject = 'Заявка с сайта Vestapack';
$mail->Body = $body;
